...
* [Column types](#column-types)
  ...
  * [Column types for `sqlite` / `nativescript` / `cordova` / `react-native` / `expo`](#column-types-for-sqlite--nativescript--cordova--react-native--expo)
...
### Column types for `sqlite` / `nativescript` / `cordova` / `react-native` / `expo`
